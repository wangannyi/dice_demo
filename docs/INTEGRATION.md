...
| `{"id":"10","command":"advance","until":"RETURN_HOME","rounds":5}` | 有界连跑 5 局（1..99）：每局完成自动复位并立即开下一局，局间发 `round_started`；任一局失败立即终止连跑（failed 退出） |
