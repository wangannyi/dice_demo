...
from geometry import deproject, estimate_points, localize
...
class GeometryTests(unittest.TestCase):
    ...
    def test_cli_registered_depth_end_to_end(self):
        ...
        with tempfile.TemporaryDirectory() as folder:
            ...
            proc = subprocess.run([sys.executable, str(Path(__file__).with_name('localize.py')),
...
class PlaneRefinementTest(unittest.TestCase):
    def test_refine_before_support_gate(self):
        ...
        from geometry import _plane, Config
        ...
        with patch('geometry.np.random.default_rng',return_value=chooser):
