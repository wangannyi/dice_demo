...
from cup_grasp_demo.calibration_debug.cup_recheck import match_candidates, verify_cup
...
class CupRecheckTest(unittest.TestCase):
    ...
    def test_failure_still_writes_matching_evidence(self):
        with tempfile.TemporaryDirectory() as temp, \
             patch('cup_grasp_demo.calibration_debug.cup_recheck.depth_candidates', return_value=([], [])):
            path = Path(temp)
