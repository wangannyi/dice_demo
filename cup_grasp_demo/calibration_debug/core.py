...
def load_config(path):
    from cup_grasp_demo.calibration_debug.cup_selection import selection_options
    from cup_grasp_demo.calibration_debug.contact_geometry import contact_azimuth
    cfg = read_json(path)
    from cup_grasp_demo.calibration_debug.cup_perception import perception_options
    ...
    from cup_grasp_demo.calibration_debug.parameters import tcp_offset
    tcp_offset(cfg)
