...
from cup_grasp_demo.calibration_debug import debug, pipeline_home, pipeline_runner as runner
from cup_grasp_demo.calibration_debug.core import ROOT, load_config, read_json, write_json
from cup_grasp_demo.calibration_debug.session_storage import dispatch, session_lock
...
class BackendTest(unittest.TestCase):
    def test_new_round_capture_uses_live_config_file_not_old_session(self):
        args = SimpleNamespace(config=ROOT / 'cup_grasp_demo/calibration_debug/index_joint_center/config.json',
...
class HomeTest(unittest.TestCase):
    ...
    def test_recorded_cup_scene_supports_home_screen_without_camera(self):
        ...
        cfg = load_config(ROOT / 'cup_grasp_demo/calibration_debug/index_joint_center/config.json')
...
class RecordedPipelineTest(unittest.TestCase):
    def test_real_geometry_and_receipts_flow_with_simulated_hardware(self):
        ...
        source = ROOT / 'cup_grasp_demo/datasets/contact_yaw20_20260917_01/current'
        raw = read_json(ROOT / 'cup_grasp_demo/calibration_debug/index_joint_center/config.json')
