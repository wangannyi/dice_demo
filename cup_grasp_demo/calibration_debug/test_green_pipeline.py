...
from cup_grasp_demo.calibration_debug.green_cup_geometry import rim_geometry, detect
from cup_grasp_demo.calibration_debug.green_cup_planning import (
    solve,
    held_cup_clearance,
    vertical_targets,
)
from cup_grasp_demo.calibration_debug.green_shake_validation import (
    validate_held_request,
)
from cup_grasp_demo.calibration_debug.core import ROOT, load_config, digest
from cup_grasp_demo.calibration_debug.shake import Kinematics

CFG = ROOT / "cup_grasp_demo/calibration_debug/green_open_cup/config.json"
...
class GreenTest(unittest.TestCase):
    ...
    def test_hand_recipe_and_feedback_failure(self):
        from cup_grasp_demo.calibration_debug import green_hand_execution as handmod
    ...
    def test_two_class_decoder_drops_ground_without_shifting_mask_coefficients(self):
        from cup_grasp_demo.calibration_debug.green_yolo import cap_outputs
