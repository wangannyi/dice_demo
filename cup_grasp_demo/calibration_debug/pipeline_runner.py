...
from cup_grasp_demo.calibration_debug import debug as common, grasp_cli
from cup_grasp_demo.calibration_debug.core import cached_file_digests, cached_screen_geometry, digest, load_config, read_json
from cup_grasp_demo.calibration_debug.pipeline_home import execute_home
from cup_grasp_demo.calibration_debug.phase_timing import emit_line, timing_line
...
class Backend:
    ...
    def shake(self):
        from cup_grasp_demo.calibration_debug import shake_cli
