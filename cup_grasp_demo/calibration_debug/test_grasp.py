...
from cup_grasp_demo.calibration_debug.contact_geometry import contact_direction
from cup_grasp_demo.calibration_debug.grasp import (
...
from cup_grasp_demo.calibration_debug.grasp_execution import execute, send_closure, validate_sequence
...
class FingerTest(unittest.TestCase):
    ...
    def test_sequence_failure_stops_before_second_hand_command(self):
        ...
        with patch('cup_grasp_demo.calibration_debug.grasp_execution.fresh_current'), \
             patch('cup_grasp_demo.calibration_debug.grasp_execution.send_closure', side_effect=RuntimeError('thumb failed')) as close:
