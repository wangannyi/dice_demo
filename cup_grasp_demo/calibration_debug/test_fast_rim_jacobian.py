...
from cup_grasp_demo.calibration_debug.green_stereo_rim import fixed_rim_residual,project,fit_circle
from cup_grasp_demo.calibration_debug import test_green_stereo_rim as fixtures
