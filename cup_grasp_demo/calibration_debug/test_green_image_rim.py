...
class ImageRimTest(unittest.TestCase):
    def setUp(self):
        self.opts = deepcopy(
            load_config(
                ROOT / "cup_grasp_demo/calibration_debug/green_open_cup/config.json"
    ...
    def test_green_detect_entry_never_requests_robot_snapshot(self):
        ...
        from cup_grasp_demo.calibration_debug import debug, green_pipeline
    ...
    def test_repeated_capture_replaces_latest_diagnostics(self):
        ...
        from types import SimpleNamespace
        from unittest.mock import patch
        from cup_grasp_demo.calibration_debug import green_pipeline as flowmod
    ...
    def test_camera_failure_invalidates_previous_target(self):
        ...
        from tempfile import TemporaryDirectory
        from unittest.mock import patch
        from cup_grasp_demo.calibration_debug import green_pipeline
...
class OpeningContourTest(unittest.TestCase):
    def test_opening_excludes_offset_lower_wall(self):
        from cup_grasp_demo.calibration_debug.green_image_rim import image_contour
