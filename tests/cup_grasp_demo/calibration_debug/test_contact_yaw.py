...
from cup_grasp_demo.calibration_debug.contact_geometry import contact_azimuth, contact_direction
...
class AzimuthTest(unittest.TestCase):
    ...
    def test_config_validation_happens_before_any_capture(self):
        source = ROOT / 'cup_grasp_demo/calibration_debug/index_joint_center/config.json'
...
class AzimuthCaptureTest(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.config = ROOT / 'cup_grasp_demo/calibration_debug/index_joint_center/config.json'
