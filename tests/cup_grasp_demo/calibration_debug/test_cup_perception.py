...
from cup_grasp_demo.calibration_debug import cup_perception as vision, debug
from cup_grasp_demo.calibration_debug.core import ROOT, digest, load_config, read_json
from cup_grasp_demo.calibration_debug.cup_selection import select_cup
...
class ModelGeometryTest(unittest.TestCase):
    ...
    def test_no_detection_does_not_use_geometric_fallback(self):
        with tempfile.TemporaryDirectory() as temp, \
             ...
             patch('cup_grasp_demo.calibration_debug.cup_selection.depth_candidates',
