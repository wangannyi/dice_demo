...
class RtspStreamerTests(unittest.TestCase):
    ...
    def test_submit_keeps_only_newest_frame(self):
        ...
        with patch('cup_grasp_demo.calibration_debug.green_rtsp.threading.Thread') as thread_cls:
            streamer = self.make()
    ...
    def test_writer_sends_frame_bytes_to_child_stdin(self):
        ...
        with patch('cup_grasp_demo.calibration_debug.green_rtsp.subprocess.Popen',
