...
from cup_grasp_demo.calibration_debug import shake, shake_study
from cup_grasp_demo.calibration_debug.parameters import shake_options

FEEDBACK = (
    ROOT / "tests/cup_grasp_demo/calibration_debug/fixtures/controller_limits.json"
)
    ...
    def test_motor_plan_does_not_require_cup_capture_success(self):
        ...
        with tempfile.TemporaryDirectory() as temp:
            ...
            with (
                ...
                patch(
                    "cup_grasp_demo.calibration_debug.pipeline_home.home_scene",
    ...
    def simulate(
        ...
        with ExitStack() as stack:
            ...
            if connected:
                ...
                from cup_grasp_demo.calibration_debug import green_shake_validation
