...
from cup_grasp_demo.calibration_debug import green_pipeline as g

class FastOverheadTest(unittest.TestCase):
    def test_fast_finger_override_preserves_step_duration(self):
        cfg=g.ROOT/'cup_grasp_demo/calibration_debug/green_open_cup/stereo_config.json'
...
class ShakeStartTest(unittest.TestCase):
    def test_small_settling_residual_and_real_start_change(self):
        import math
        from cup_grasp_demo.calibration_debug import joint_execution as execution
