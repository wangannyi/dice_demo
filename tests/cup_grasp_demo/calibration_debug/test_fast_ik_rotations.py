...
class FastIKTests(unittest.TestCase):
    ...
    def test_lift_minimax_failure_keeps_original_solution(self):
        ...
        from cup_grasp_demo.calibration_debug.green_cup_planning import minimize_joint_travel
        start = np.radians([25, -80, -100, 70, 0, -13, 5])
        with patch('cup_grasp_demo.calibration_debug.green_cup_planning.minimize', return_value=SimpleNamespace(success=False)):
