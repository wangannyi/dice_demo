...
from cup_grasp_demo.flow.grasp import FINGER_TARGETS, make_grasp_plan, observed_scene, options
from cup_grasp_demo.flow.grasp_execution import execute, validate_sequence
...
class DirectGraspTest(unittest.TestCase):
    ...
    def test_failed_motion_never_starts_closure(self):
        ...
        with patch('cup_grasp_demo.flow.grasp_execution.fresh_current'), \
             patch('cup_grasp_demo.flow.grasp_execution.send_closure') as close:
