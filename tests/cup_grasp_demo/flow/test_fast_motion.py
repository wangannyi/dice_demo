...
from cup_grasp_demo.flow import grasp_cli, shake_tracking
from cup_grasp_demo.flow.core import ROOT, Screen, load_config, read_json, write_json
from cup_grasp_demo.flow.direct_grasp import approach_stages, make_direct_plan
from cup_grasp_demo.flow.grasp import options
from cup_grasp_demo.flow.parameters import approach_options, shake_options
...
class DirectRouteTest(unittest.TestCase):
    ...
    def test_direct_path_blockage_falls_back_instead_of_skipping_screen(self):
        with patch('cup_grasp_demo.flow.direct_grasp.direct_transfer',
